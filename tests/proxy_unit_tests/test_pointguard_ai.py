...
Following LiteLLM's testing patterns (similar to Azure Prompt Shield tests)
"""
...
async def test_pointguard_pre_call_hook_no_violations():
    ...
    guardrail = PointGuardAIGuardrail(
        ...
        api_key="0be7461c6d9346439ecbac9075f4bec370f958d0c362425ba8e8180b5722f07d",
        api_email="schalla@appsoc.com",
        api_base="https://api.sqa1.appsoc.com",
        org_code="demodevelop",
        policy_config_name="sandeep-test",
    )
